<?php
/**
 * 一款相册主题，基于ZHHEO的TimePlus主题
 * @package TimeX
 * @author MysticStars
 * @version 1.0
 * @link https://me.mysticstars.cn
 */
?>
<!DOCTYPE html>
<html>
...
">
              ...
              <span style="color: #b5b5b5; font-size: 0.8em;">
                ...
                <p class="copyright">
                    &copy; 设计 ZHHEO & ZMKI & Mystic_Stars 主题：<a href="https://github.com/mystic-stars/TimeX" target="_blank" rel="noopener nofollow">TimeX</a>.
                    <?php
